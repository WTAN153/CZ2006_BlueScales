...
*/
                  ...
                  SizedBox(height: 20.0),
                  Text("Email: ${userData.email}" ,style: TextStyle(fontSize: 20, color: Colors.black) ),  // edit profile in the futrue
                  SizedBox(height: 20.0),
                  ...
                  Form(key: _formKey,
                    ...
                    children:<Widget>[                  // 2 widget side by side in the column
                      Row(                              // use row
                        ...
                        Text("Username: ", style: TextStyle(fontSize: 20, color: Colors.black),),
                          ...
                          validator: (val) => val.isEmpty ? 'Please enter a name' : null,        //if no username it will ask for it.
                      ...
                      Row(                              // use row
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children:[
                            Text("Phone no: ", style: TextStyle(fontSize: 20, color: Colors.black),),
                            Container(
                              width: 140,
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(),
                                style:  TextStyle(fontSize: 18.0,color: Colors.black),
                                validator: (val) => val.isEmpty ? 'Please enter a phone' : null,        //if no username it will ask for it.
                      ...
                      SizedBox(height: 20.0),
                       RaisedButton(                                             // enter to change username
                              ...
                              onPressed: () async {
                                if(_formKey.currentState.validate()){
                                  await DataAccess(uid: user).updateUserData(
                                      userData.email,
                                      _currentName ?? userData.name,            // store it in the userdatabase with userid
