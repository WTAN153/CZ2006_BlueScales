              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    onChanged: (value) {
                      _email = value.trim(); // store the email typed in _email
                    },
                  ),
                ),
                SizedBox(height: 20),
                ...
                Container(
                  width: 350,
                  child: TextField(
                    obscureText: true, // mask the password typed
                    style: TextStyle(color: Colors.black),
                    decoration: InputDecoration(
                        labelText: 'Password',
                ...
                Align(
                  alignment:
                      Alignment(0.7, 0), // make button position to the right
                  child: MaterialButton(
                    ...
                    onPressed: () async {
                      try {
                        verifiedLogin = await LoginController.verifylogin(
                            _email.toString().trim(),
                            _password.toString().trim()); // LoginController
